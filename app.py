...
def get_info():
    ...
    # Decide which cookie file to use based on URL domain (simple check)
    if "youtube.com" in video_url or "youtu.be" in video_url:
        cookie_file = 'cookies_youtube.txt'
    elif "instagram.com" in video_url:
        cookie_file = 'cookies_insta.txt'
    else:
        # Default or unknown sites can be handled here
        cookie_file = None
...
# Endpoint to update YouTube cookies
...
# Endpoint to update Instagram cookies
